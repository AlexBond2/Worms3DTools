...
type
  ...
  TDxtCallback = procedure(const Handle: pointer; var BGRABlock: TBGRABlock; const X, Y: integer);

  // Header
  function  DxtHeader(const Width, Height: integer; const Dxt1: boolean): TDxtHeader;

  // Flip
  procedure DxtFlip(const DxtBlocks: pointer; const Dxt1: boolean; const BlocksCount: integer); overload;
  procedure DxtFlip(var Dest: TDxt1Block); overload;
  procedure DxtFlip(var Dest: TDxt5Block); overload;

  // Decompressing
  procedure DxtDecompress(const Dest: pointer; const DxtBlock: pointer; const Dxt1: boolean; const line_size: integer = 16); overload;
  ...
  // Compressing
  procedure DxtCompress(const Dest: pointer; const BGRABlock: TBGRABlock; const Dxt1: boolean); overload;
  procedure DxtCompress(var Dest: TDxt1Block; const BGRABlock: TBGRABlock); overload;
  procedure DxtCompress(var Dest: TDxt5Block; const BGRABlock: TBGRABlock); overload;

  // Compressing, data mode
  procedure DxtCompressData(const Dest: pointer; const BGRABlock: TBGRABlock; const Dxt1: boolean); overload;
  procedure DxtCompressData(var Dest: TDxt1Block; const BGRABlock: TBGRABlock); overload;
  procedure DxtCompressData(var Dest: TDxt5Block; const BGRABlock: TBGRABlock); overload;

  // Image
  function  DxtImageSize(const Dxt1: boolean; const ImageWidth, ImageHeight: integer): integer;
  function  DxtImageAlpha(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer): TDxtAlphaKind;
  procedure DxtImageFlip(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer);
  procedure DxtImageResize(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer; const DestDxtBlocks: pointer; const DestImageWidth, DestImageHeight: integer);
  procedure DxtImageDecompress(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer; const Handle: pointer; const Callback: TDxtCallback);
  procedure DxtImageCompress(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer; const Handle: pointer; const Callback: TDxtCallback; const DataMode: boolean=false);
  procedure DxtImageCompressParallel(const DxtBlocks: pointer; const Dxt1: boolean; const ImageWidth, ImageHeight: integer; const Handle: pointer; const Callback: TDxtCallback; const DataMode: boolean=false);
...
type
  TDDPixelFormat = array[0..31] of byte;

const
  DD_PIXEL_FORMATS_DATA: array[0..64-1] of byte =(
  $20,$00,$00,$00,$04,$00,$00,$00,$44,$58,$54,$31,$00,$00,$00,$00,$00,$00,$00,
  $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$20,$00,$00,$00,$04,$00,
  $00,$00,$44,$58,$54,$35,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,
  $00,$00,$00,$00,$00,$00,$00);

var
  DD_PIXEL_FORMATS: array[boolean{Dxt5}] of TDDPixelFormat absolute DD_PIXEL_FORMATS_DATA;

function DxtHeader(const Width, Height: integer; const Dxt1: boolean): TDxtHeader;
const
  FLAGS = $00080000 or $00000001 or $00000002 or $00000004 or $00001000;
begin
  FillChar(Result, sizeof(Result), #0);
  
  Result.dwMagic := 'DDS ';
  Result.__Size := 124;
  Result.__Flags := FLAGS; //DDSD_CAPS or DDSD_LINEARSIZE or DDSD_HEIGHT or DDSD_WIDTH or DDSD_PIXELFORMAT;
  Result.dwWidth := Width;
  Result.dwHeight := Height;
  Result.dwLinearSize := ((Width+3) div 4) * ((Height+3) div 4) * DXT_BLOCK_SIZES[Dxt1];

  TDDPixelFormat(pointer(@Result.__Buffer1[52])^) := DD_PIXEL_FORMATS[not Dxt1]; // pixel format
  pinteger(@Result.__Buffer2[20])^ := $00001000; // ddsCaps.dwCaps := DDSCAPS_TEXTURE;
end;


procedure DxtFlip(const DxtBlocks: pointer; const Dxt1: boolean; const BlocksCount: integer);
asm
...
function  DxtImageSize(const Dxt1: boolean; const ImageWidth, ImageHeight: integer): integer;
begin
  if (ImageWidth <= 0) or (ImageHeight <= 0) then Result := 0
  else
  Result := ((ImageWidth+3) div 4) * ((ImageHeight+3) div 4) * DXT_BLOCK_SIZES[Dxt1];
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if (P1 = P2) then DxtFlip(P1, Dxt1, BlocksWidth);
      end;
    end;
  finally
    FreeMem(Buffer);
...
begin
  ...
  if (DestWidth <= 0) or (DestHeight <= 0) or (SrcWidth < 0) or (SrcHeight < 0) then exit;
  ...
  WidthToCopy := DestWidth; if (WidthToCopy > SrcWidth) then WidthToCopy := SrcWidth;
  HeightToCopy := DestHeight; if (HeightToCopy > SrcHeight) then HeightToCopy := SrcHeight;
  for Y := 0 to HeightToCopy-1 do
  begin
    CopyBlocks(WidthToCopy);

    if (DestWidth > SrcWidth) then ZeroBlocks(DestWidth-SrcWidth)
    else
    if (DestWidth < SrcWidth) then inc(integer(SrcBlock), (SrcWidth-DestWidth)*BlockSize);
  end;
...
procedure DxtInternalImageCompress(const DxtBlocks: pointer; const Mask, ImageWidth, ImageHeight: integer;
                                   const Handle: pointer; const Callback: TDxtCallback);
type
  TRealDxtCompress = procedure(const Dest: pointer; const BGRABlock: TBGRABlock; const Mask: integer);
var
  X, Y: integer;
  Block: pointer;
  BlockSize: integer;
...
begin
  Mask := ord(Dxt1);
  if (DataMode) then Mask := Mask or 2;

  DxtInternalImageCompress(DxtBlocks, Mask, ImageWidth, ImageHeight, Handle, Callback);
end;
...
procedure DxtDecompress(const Dest: pointer; const DxtBlock: pointer; const Dxt1: boolean; const line_size: integer = 16);
const
  BITS_5 = int64((1 shl 5) - 1);
  BITS_6 = int64((1 shl 6) - 1);

  MASK_6: int64 = (BITS_6 shl 5) or (BITS_6 shl (32+5));
  MASK_5: int64 = (BITS_5 shl 9) or (BITS_5 shl 20) or (BITS_5 shl (32+9)) or (BITS_5 shl (32+20));
...
type
  TDxtCallbackColorsCompress = procedure(const Dest, ColourSet, DxtConstsData: pointer); cdecl;
  TDxtCallbackAlphaCompress = procedure(const Dest, BGRA, DxtConstsData: pointer); cdecl;
...
const DXT_CONSTS_SIZE = 320;
const DXT_CONSTS_DATA: array[0..336-1] of byte = (
$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,
$00,$00,$00,$00,$10,$10,$10,$10,$10,$10,$70,$3F,$00,$00,$00,$00,$00,$00,$00,$00,
$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$80,$3F,$00,$00,$80,$3F,$00,$00,$80,$3F,
$00,$00,$80,$3F,$FF,$FF,$7F,$7F,$FF,$FF,$7F,$7F,$FF,$FF,$7F,$7F,$FF,$FF,$7F,$7F,
$00,$00,$00,$3F,$00,$00,$00,$3F,$00,$00,$00,$3F,$00,$00,$80,$3E,$AB,$AA,$AA,$3E,
$AB,$AA,$AA,$3E,$AB,$AA,$AA,$3E,$39,$8E,$E3,$3D,$AB,$AA,$2A,$3F,$AB,$AA,$2A,$3F,
$AB,$AA,$2A,$3F,$39,$8E,$E3,$3E,$39,$8E,$63,$3E,$39,$8E,$63,$3E,$39,$8E,$63,$3E,
$39,$8E,$63,$3E,$00,$00,$F8,$41,$00,$00,$7C,$42,$00,$00,$F8,$41,$00,$00,$00,$00,
$08,$21,$04,$3D,$21,$08,$82,$3C,$08,$21,$04,$3D,$00,$00,$00,$00,$00,$00,$40,$4B,
$00,$00,$40,$4B,$00,$00,$40,$4B,$00,$00,$00,$00,$00,$40,$00,$00,$00,$40,$00,$00,
$00,$00,$05,$00,$04,$00,$03,$00,$00,$00,$00,$00,$01,$00,$02,$00,$02,$00,$01,$00,
$00,$00,$00,$00,$03,$00,$04,$00,$05,$00,$00,$00,$00,$00,$01,$00,$02,$00,$03,$00,
$04,$00,$05,$00,$06,$00,$07,$00,$07,$00,$06,$00,$05,$00,$04,$00,$03,$00,$02,$00,
$01,$00,$00,$00,$00,$06,$00,$00,$00,$02,$00,$03,$00,$04,$00,$05,$00,$01,$00,$07,
$00,$01,$00,$07,$00,$06,$00,$05,$00,$04,$00,$03,$00,$02,$00,$00,$00,$00,$00,$00,
$00,$00,$FF,$00,$34,$33,$34,$33,$34,$33,$34,$33,$93,$24,$93,$24,$93,$24,$93,$24,
$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00);

const DXT_SINGLECOLORS: array[0..2048-1] of byte = (
$00,$00,$00,$00,$00,$01,$00,$01,$00,$02,$00,$02,$00,$03,$00,$03,$00,$04,$00,$04,
$00,$05,$00,$05,$00,$06,$00,$06,$00,$07,$00,$07,$00,$08,$00,$08,$00,$09,$00,$09,
$00,$0A,$00,$0A,$00,$0B,$00,$0B,$00,$0C,$00,$0C,$00,$0D,$00,$0D,$00,$0E,$00,$0E,
$00,$0F,$00,$0F,$00,$10,$00,$10,$00,$11,$00,$11,$00,$12,$00,$12,$00,$13,$00,$13,
$00,$14,$00,$14,$00,$15,$00,$15,$00,$16,$00,$16,$00,$17,$00,$17,$00,$18,$00,$18,
$00,$19,$00,$19,$00,$1A,$00,$1A,$00,$1B,$00,$1B,$00,$1C,$00,$1C,$00,$1D,$00,$1D,
$00,$1E,$00,$1E,$00,$1F,$00,$1F,$01,$1F,$00,$20,$02,$1F,$00,$21,$03,$1F,$00,$22,
$04,$1F,$00,$23,$05,$1F,$00,$24,$06,$1F,$00,$25,$07,$1F,$00,$26,$08,$1F,$00,$27,
$09,$1F,$00,$28,$0A,$1F,$00,$29,$0B,$1F,$00,$2A,$0C,$1F,$00,$2B,$0D,$1F,$00,$2C,
$0E,$1F,$00,$2D,$0F,$1F,$00,$2E,$00,$2E,$00,$2F,$00,$2F,$00,$30,$00,$30,$00,$31,
$00,$31,$00,$32,$00,$32,$00,$33,$00,$33,$00,$34,$00,$34,$00,$35,$00,$35,$00,$36,
$00,$36,$00,$37,$00,$37,$00,$38,$00,$38,$00,$39,$00,$39,$00,$3A,$00,$3A,$00,$3B,
$00,$3B,$00,$3C,$00,$3C,$00,$3D,$00,$3D,$00,$3E,$00,$3E,$00,$3F,$00,$3F,$01,$3F,
$10,$30,$02,$3F,$10,$31,$03,$3F,$10,$32,$04,$3F,$10,$33,$05,$3F,$10,$34,$06,$3F,
$10,$35,$07,$3F,$10,$36,$08,$3F,$10,$37,$09,$3F,$10,$38,$0A,$3F,$10,$39,$0B,$3F,
$10,$3A,$0C,$3F,$10,$3B,$0D,$3F,$10,$3C,$0E,$3F,$10,$3D,$0F,$3F,$10,$3E,$10,$3E,
$10,$3F,$10,$3F,$11,$3F,$11,$3F,$12,$3F,$12,$3F,$13,$3F,$13,$3F,$14,$3F,$14,$3F,
$15,$3F,$15,$3F,$16,$3F,$16,$3F,$17,$3F,$17,$3F,$18,$3F,$18,$3F,$19,$3F,$19,$3F,
$1A,$3F,$1A,$3F,$1B,$3F,$1B,$3F,$1C,$3F,$1C,$3F,$1D,$3F,$1D,$3F,$1E,$3F,$1E,$3F,
$1F,$3F,$1F,$3F,$20,$3F,$20,$3F,$21,$3F,$30,$30,$22,$3F,$30,$31,$23,$3F,$30,$32,
$24,$3F,$30,$33,$25,$3F,$30,$34,$26,$3F,$30,$35,$27,$3F,$30,$36,$28,$3F,$30,$37,
$29,$3F,$30,$38,$2A,$3F,$30,$39,$2B,$3F,$30,$3A,$2C,$3F,$30,$3B,$2D,$3F,$30,$3C,
$2E,$3F,$30,$3D,$2F,$3F,$30,$3E,$30,$3E,$30,$3F,$30,$3F,$31,$3F,$31,$3F,$32,$3F,
$32,$3F,$33,$3F,$33,$3F,$34,$3F,$34,$3F,$35,$3F,$35,$3F,$36,$3F,$36,$3F,$37,$3F,
$37,$3F,$38,$3F,$38,$3F,$39,$3F,$39,$3F,$3A,$3F,$3A,$3F,$3B,$3F,$3B,$3F,$3C,$3F,
$3C,$3F,$3D,$3F,$3D,$3F,$3E,$3F,$3E,$3F,$3F,$3F,$00,$00,$00,$00,$00,$00,$00,$01,
$00,$01,$00,$01,$00,$01,$00,$02,$00,$02,$00,$02,$00,$02,$00,$03,$00,$03,$00,$03,
$00,$03,$00,$04,$00,$04,$00,$04,$00,$04,$00,$05,$00,$05,$00,$05,$00,$05,$00,$06,
$00,$06,$00,$06,$00,$06,$00,$07,$00,$07,$00,$07,$00,$07,$01,$07,$01,$07,$00,$08,
$00,$08,$02,$07,$02,$07,$00,$09,$00,$09,$03,$07,$03,$07,$00,$0A,$00,$0A,$00,$0A,
$00,$0B,$00,$0B,$00,$0B,$00,$0B,$00,$0C,$00,$0C,$00,$0C,$00,$0C,$00,$0D,$00,$0D,
$00,$0D,$00,$0D,$00,$0E,$00,$0E,$00,$0E,$00,$0E,$00,$0F,$00,$0F,$00,$0F,$00,$0F,
$01,$0F,$01,$0F,$00,$10,$00,$10,$02,$0F,$02,$0F,$00,$11,$00,$11,$03,$0F,$03,$0F,
$00,$12,$00,$12,$00,$12,$00,$13,$00,$13,$00,$13,$00,$13,$00,$14,$00,$14,$00,$14,
$00,$14,$00,$15,$00,$15,$00,$15,$00,$15,$00,$16,$00,$16,$00,$16,$00,$16,$00,$17,
$00,$17,$00,$17,$00,$17,$01,$17,$01,$17,$00,$18,$00,$18,$02,$17,$02,$17,$00,$19,
$00,$19,$03,$17,$03,$17,$00,$1A,$00,$1A,$00,$1A,$00,$1B,$00,$1B,$00,$1B,$00,$1B,
$00,$1C,$00,$1C,$00,$1C,$00,$1C,$00,$1D,$00,$1D,$00,$1D,$00,$1D,$00,$1E,$00,$1E,
$00,$1E,$00,$1E,$00,$1F,$00,$1F,$00,$1F,$00,$1F,$01,$1F,$01,$1F,$04,$1C,$04,$1C,
$02,$1F,$02,$1F,$04,$1D,$04,$1D,$03,$1F,$03,$1F,$04,$1E,$04,$1E,$04,$1E,$04,$1F,
$04,$1F,$04,$1F,$04,$1F,$05,$1F,$05,$1F,$05,$1F,$05,$1F,$06,$1F,$06,$1F,$06,$1F,
$06,$1F,$07,$1F,$07,$1F,$07,$1F,$07,$1F,$08,$1F,$08,$1F,$08,$1F,$08,$1F,$09,$1F,
$09,$1F,$0C,$1C,$0C,$1C,$0A,$1F,$0A,$1F,$0C,$1D,$0C,$1D,$0B,$1F,$0B,$1F,$0C,$1E,
$0C,$1E,$0C,$1E,$0C,$1F,$0C,$1F,$0C,$1F,$0C,$1F,$0D,$1F,$0D,$1F,$0D,$1F,$0D,$1F,
$0E,$1F,$0E,$1F,$0E,$1F,$0E,$1F,$0F,$1F,$0F,$1F,$0F,$1F,$0F,$1F,$10,$1F,$10,$1F,
$10,$1F,$10,$1F,$11,$1F,$11,$1F,$14,$1C,$14,$1C,$12,$1F,$12,$1F,$14,$1D,$14,$1D,
$13,$1F,$13,$1F,$14,$1E,$14,$1E,$14,$1E,$14,$1F,$14,$1F,$14,$1F,$14,$1F,$15,$1F,
$15,$1F,$15,$1F,$15,$1F,$16,$1F,$16,$1F,$16,$1F,$16,$1F,$17,$1F,$17,$1F,$17,$1F,
$17,$1F,$18,$1F,$18,$1F,$18,$1F,$18,$1F,$19,$1F,$19,$1F,$1C,$1C,$1C,$1C,$1A,$1F,
$1A,$1F,$1C,$1D,$1C,$1D,$1B,$1F,$1B,$1F,$1C,$1E,$1C,$1E,$1C,$1E,$1C,$1F,$1C,$1F,
$1C,$1F,$1C,$1F,$1D,$1F,$1D,$1F,$1D,$1F,$1D,$1F,$1E,$1F,$1E,$1F,$1E,$1F,$1E,$1F,
$1F,$1F,$1F,$1F,$00,$00,$00,$01,$01,$00,$01,$00,$01,$01,$02,$00,$02,$01,$03,$00,
$03,$00,$03,$01,$04,$00,$04,$00,$04,$01,$05,$00,$05,$01,$06,$00,$06,$00,$06,$01,
$07,$00,$07,$00,$07,$01,$08,$00,$08,$01,$00,$11,$09,$00,$09,$01,$0A,$00,$02,$10,
$0A,$01,$0B,$00,$0B,$01,$03,$11,$0C,$00,$0C,$01,$0D,$00,$05,$10,$0D,$01,$0E,$00,
$0E,$01,$06,$11,$0F,$00,$0F,$01,$0F,$02,$10,$00,$10,$01,$0F,$04,$11,$00,$11,$01,
$12,$00,$0F,$07,$12,$01,$13,$00,$13,$01,$0F,$0A,$14,$00,$14,$01,$15,$00,$0F,$0D,
$15,$01,$16,$00,$16,$01,$0F,$10,$17,$00,$17,$01,$18,$00,$10,$10,$18,$01,$19,$00,
$19,$01,$11,$11,$1A,$00,$1A,$01,$1B,$00,$13,$10,$1B,$01,$1C,$00,$1C,$01,$14,$11,
$1D,$00,$1D,$01,$1E,$00,$16,$10,$1E,$01,$1F,$00,$1F,$01,$17,$11,$20,$00,$1F,$03,
$20,$01,$21,$00,$21,$01,$1F,$06,$22,$00,$22,$01,$23,$00,$1F,$09,$23,$01,$24,$00,
$24,$01,$1F,$0C,$25,$00,$25,$01,$26,$00,$1F,$0F,$26,$01,$27,$00,$27,$01,$1F,$12,
$28,$00,$28,$01,$29,$00,$21,$10,$29,$01,$2A,$00,$2A,$01,$22,$11,$2B,$00,$2B,$01,
$2C,$00,$24,$10,$2C,$01,$2D,$00,$2D,$01,$25,$11,$2E,$00,$2E,$01,$2F,$00,$27,$10,
$2F,$01,$2F,$02,$30,$00,$30,$01,$31,$00,$2F,$05,$31,$01,$32,$00,$32,$01,$2F,$08,
$33,$00,$33,$01,$34,$00,$2F,$0B,$34,$01,$35,$00,$35,$01,$2F,$0E,$36,$00,$36,$01,
$37,$00,$2F,$11,$37,$01,$38,$00,$38,$01,$30,$11,$39,$00,$39,$01,$3A,$00,$32,$10,
$3A,$01,$3B,$00,$3B,$01,$33,$11,$3C,$00,$3C,$01,$3D,$00,$35,$10,$3D,$01,$3E,$00,
$3E,$01,$36,$11,$3F,$00,$3F,$01,$3F,$02,$38,$10,$3F,$03,$3F,$04,$3F,$05,$39,$11,
$3F,$06,$3F,$07,$3F,$08,$3B,$10,$3F,$09,$3F,$0A,$3F,$0B,$3C,$11,$3F,$0C,$3F,$0D,
$3F,$0E,$3E,$10,$3F,$0F,$3F,$10,$37,$20,$3F,$11,$3F,$12,$3F,$13,$38,$21,$3F,$14,
$3F,$15,$3F,$16,$3A,$20,$3F,$17,$3F,$18,$3F,$19,$3B,$21,$3F,$1A,$3F,$1B,$3F,$1C,
$3D,$20,$3F,$1D,$3F,$1E,$3F,$1F,$3E,$21,$3F,$20,$3F,$21,$37,$31,$3F,$22,$3F,$23,
$3F,$24,$39,$30,$3F,$25,$3F,$26,$3F,$27,$3A,$31,$3F,$28,$3F,$29,$3F,$2A,$3C,$30,
$3F,$2B,$3F,$2C,$3F,$2D,$3D,$31,$3F,$2E,$3F,$2F,$3F,$2F,$3F,$30,$3F,$31,$3F,$32,
$3F,$32,$3F,$33,$3F,$34,$3F,$35,$3F,$35,$3F,$36,$3F,$37,$3F,$38,$3F,$38,$3F,$39,
$3F,$3A,$3F,$3B,$3F,$3B,$3F,$3C,$3F,$3D,$3F,$3E,$3F,$3E,$3F,$3F,$00,$00,$00,$00,
$00,$01,$00,$01,$01,$00,$01,$00,$01,$00,$01,$01,$01,$01,$02,$00,$02,$00,$00,$04,
$02,$01,$02,$01,$02,$01,$03,$00,$03,$00,$03,$00,$03,$01,$01,$05,$03,$02,$03,$02,
$04,$00,$04,$00,$04,$01,$04,$01,$05,$00,$05,$00,$05,$00,$03,$05,$05,$01,$06,$00,
$06,$00,$04,$04,$06,$01,$06,$01,$06,$01,$07,$00,$07,$00,$07,$00,$07,$01,$05,$05,
$07,$02,$07,$02,$08,$00,$08,$00,$08,$01,$08,$01,$09,$00,$09,$00,$09,$00,$07,$05,
$09,$01,$0A,$00,$0A,$00,$08,$04,$0A,$01,$0A,$01,$0A,$01,$0B,$00,$0B,$00,$0B,$00,
$0B,$01,$09,$05,$0B,$02,$0B,$02,$0C,$00,$0C,$00,$0C,$01,$0C,$01,$0D,$00,$0D,$00,
$0D,$00,$0B,$05,$0D,$01,$0E,$00,$0E,$00,$0C,$04,$0E,$01,$0E,$01,$0E,$01,$0F,$00,
$0F,$00,$0F,$00,$0F,$01,$0D,$05,$0F,$02,$0F,$02,$10,$00,$10,$00,$10,$01,$10,$01,
$11,$00,$11,$00,$11,$00,$0F,$05,$11,$01,$12,$00,$12,$00,$10,$04,$12,$01,$12,$01,
$12,$01,$13,$00,$13,$00,$13,$00,$13,$01,$11,$05,$13,$02,$13,$02,$14,$00,$14,$00,
$14,$01,$14,$01,$15,$00,$15,$00,$15,$00,$13,$05,$15,$01,$16,$00,$16,$00,$14,$04,
$16,$01,$16,$01,$16,$01,$17,$00,$17,$00,$17,$00,$17,$01,$15,$05,$17,$02,$17,$02,
$18,$00,$18,$00,$18,$01,$18,$01,$19,$00,$19,$00,$19,$00,$17,$05,$19,$01,$1A,$00,
$1A,$00,$18,$04,$1A,$01,$1A,$01,$1A,$01,$1B,$00,$1B,$00,$1B,$00,$1B,$01,$19,$05,
$1B,$02,$1B,$02,$1C,$00,$1C,$00,$1C,$01,$1C,$01,$1D,$00,$1D,$00,$1D,$00,$1B,$05,
$1D,$01,$1E,$00,$1E,$00,$1C,$04,$1E,$01,$1E,$01,$1E,$01,$1F,$00,$1F,$00,$1F,$00,
$1F,$01,$1D,$05,$1F,$02,$1F,$02,$1C,$08,$1F,$03,$1F,$03,$1F,$03,$1F,$04,$1F,$04,
$1F,$04,$1F,$05,$1D,$09,$1F,$06,$1F,$06,$1C,$0C,$1F,$07,$1F,$07,$1F,$07,$1F,$08,
$1F,$08,$1F,$08,$1F,$09,$1D,$0D,$1F,$0A,$1F,$0A,$1C,$10,$1F,$0B,$1F,$0B,$1F,$0B,
$1F,$0C,$1F,$0C,$1F,$0C,$1F,$0D,$1D,$11,$1F,$0E,$1F,$0E,$1C,$14,$1F,$0F,$1F,$0F,
$1F,$0F,$1F,$10,$1F,$10,$1F,$10,$1F,$11,$1D,$15,$1F,$12,$1F,$12,$1C,$18,$1F,$13,
$1F,$13,$1F,$13,$1F,$14,$1F,$14,$1F,$14,$1F,$15,$1D,$19,$1F,$16,$1F,$16,$1C,$1C,
$1F,$17,$1F,$17,$1F,$17,$1F,$18,$1F,$18,$1F,$18,$1F,$19,$1D,$1D,$1F,$1A,$1F,$1A,
$1F,$1A,$1F,$1B,$1F,$1B,$1F,$1B,$1F,$1C,$1F,$1C,$1F,$1C,$1F,$1D,$1F,$1D,$1F,$1E,
$1F,$1E,$1F,$1E,$1F,$1F,$1F,$1F);
...
procedure DXT_MT_ColorsCompress(const Dest, ColourSet, DxtConstsData: pointer); cdecl; forward;
procedure DXT_MT_AlphaCompress(const Dest, BGRA, DxtConstsData: pointer); cdecl; forward;


procedure DxtCompress(const Dest: pointer; const BGRABlock: TBGRABlock; const Dxt1: boolean{integer});
asm
  // fastcall --> stdcall
...
procedure DxtCompressData(const Dest: pointer; const BGRABlock: TBGRABlock; const Dxt1: boolean);
asm
...
type
  ...
  TDxtColourSet = record
    ...
    __data: array[1..(54-2)] of dword; // other internal data storage (including alpha)
  end;
  ...
  public
    ...
    // (Only after Run)
    procedure AddFilled(const Destination: pointer; const ColourSet: TDxtColourSet);
...
procedure TDxtMTGlobalArray.AddFilled(const Destination: pointer; const ColourSet: TDxtColourSet);
var
  Done: boolean;
begin
  while (true) do
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          // color compressing
          DxtConstsData.ColorsCompress(Destination, @ColourSet, DxtConstsData);
        end else
        begin
          // alpha compressing
          DxtConstsData.AlphaCompress(Destination, @ColourSet.__data, DxtConstsData);
        end;
      end;
    end;
  end;
...
begin
  ...
  try
    ...
    begin
      {$ifdef MSWINDOWS}
        FThreadsData[i] := System.BeginThread(nil, 0, TThreadFunc(@DxtThreadProc), Pointer(@Self), 0, buf);
...
begin
  ...
  begin
    ...
    FCS.Enter;
      if (FThreadCount = 0) then Done := true;
    FCS.Leave;
...
procedure DXT_MT_ColorsCompress(const Dest, ColourSet, DxtConstsData: pointer); cdecl;
begin
...
initialization
  ...
  CheckCPU();
  if (CPU_COUNT <> 1) then DxtMTGlobalArray.Initialize;

finalization
  if (CPU_COUNT <> 1) then DxtMTGlobalArray.Finalize;
