object FormXom: TFormXom
  ...
  Width = 1000
  Height = 728
  Caption = 'XomView v3.1 by AlexBond'
  Color = clBtnFace
    ...
    object Panel2: TPanel
      ...
      object Panel12: TPanel
        ...
        object ForceOn: TCheckBox
          ...
          Width = 49
          Height = 17
          Hint = 'Show forced selected XType'
          Caption = 'Force'
        ...
        object Panel3: TPanel
          ...
          object Panel1: TPanel
            ...
            object TrackPanel1: TTrackPanel
              ...
              AreaSize.MinHeight = -100.000000000000000000
              AreaSize.MaxHeight = 100.000000000000000000
              AreaSize.MaxWidth = 1.000000000000000000
              AreaDiv = 5.000000000000000000
              AreaTick = 7
      ...
      object TabSheet5: TTabSheet
        ...
        object Panel22: TPanel
          ...
          object Panel23: TPanel
            ...
            FullRepaint = False
            TabOrder = 0
            object OpenLang: TButton
              Left = 11
              Top = 8
              Width = 73
              Height = 25
              Caption = 'Open lang file'
              TabOrder = 0
              OnClick = OpenLangClick
            end
            object SaveLang: TButton
              Left = 91
              Top = 8
              Width = 73
              Height = 25
          ...
          object LangString: TTntRichEdit
            Left = 0
            Top = 431
            Width = 611
            Height = 211
          ...
          object LangStrings: TTntStringGrid
            Left = 0
            Top = 41
            Width = 611
            Height = 390
            ...
            ParentFont = False
            TabOrder = 2
            OnSelectCell = LangStringsSelectCell
          end
        end
      end
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object XWeightSet1: TMenuItem
      Caption = 'XWeightSet'
      Enabled = False
      object toXPallette: TMenuItem
        Caption = '-> XPaletteWeightSet'
        OnClick = toXPalletteClick
      end
    end
    ...
    object AddXResource1: TMenuItem
      Caption = 'Add XResource'
      Enabled = False
      object IntResources1: TMenuItem
        Caption = 'IntResources'
        OnClick = XResourcesClick
      end
      object UintResources1: TMenuItem
        Tag = 1
        Caption = 'UintResources'
        OnClick = XResourcesClick
      end
      object StringResources1: TMenuItem
        Tag = 2
        Caption = 'StringResources'
        OnClick = XResourcesClick
      end
      object FloatResources1: TMenuItem
        Tag = 3
        Caption = 'FloatResources'
        OnClick = XResourcesClick
      end
      object VectorResources1: TMenuItem
        Tag = 4
        Caption = 'VectorResources'
        OnClick = XResourcesClick
      end
      object ContainerResources1: TMenuItem
        Tag = 5
        Caption = 'ContainerResources'
        Visible = False
        OnClick = XResourcesClick
      end
      object ColorResources1: TMenuItem
        Tag = 7
        Caption = 'ColorResources'
        OnClick = XResourcesClick
      end
    end
    object FixXString1: TMenuItem
      Caption = 'Fix XString'
      OnClick = FixXString1Click
    end
    object N4: TMenuItem
      Caption = '-'
    end
    ...
    object Exportxomas1: TMenuItem
      Caption = 'Export Cntr as...'
      object W3D1: TMenuItem
        Caption = 'W3D'
        OnClick = W3D1Click
      end
    end
    ...
    object AddXValue1: TMenuItem
      Caption = 'Add XValue'
      Enabled = False
      OnClick = AddXValue1Click
    end
    object DeleteXValue1: TMenuItem
      Caption = 'Delete XValue'
      Enabled = False
      OnClick = DeleteXValue1Click
    end
    object N6: TMenuItem
      Caption = '-'
    end
    ...
    object InsertinXGraph: TMenuItem
      Caption = 'Insert in XGraph...'
      OnClick = InsertinXGraphClick
    end
    object DeletefromXGraph: TMenuItem
      Caption = 'Delete from XGraph'
      OnClick = DeletefromXGraphClick
    end
  end
  ...
  object OpenLangDialog: TOpenDialog
    Filter = 'Language files|*.bin'
    Left = 456
    Top = 184
  end
  object DummyMenu: TPopupMenu
    OnPopup = DummyMenuPopup
    Left = 344
    Top = 240
    object DummySelect: TMenuItem
      Caption = 'Select XMesh '
      object XMesh11: TMenuItem
        Caption = 'XMesh1'
        OnClick = XMesh11Click
      end
    end
    object DeleteXMesh1: TMenuItem
      Caption = 'Delete XMesh'
      Enabled = False
      OnClick = DeleteXMesh1Click
    end
  end
end
